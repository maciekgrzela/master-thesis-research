...
namespace Persistence
{
    public class Seed
    {
        public static async Task SeedData(DataReadContext context, UserManager<User> userManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        public static async Task SeedData(DataWriteContext context, UserManager<User> userManager, RoleManager<IdentityRole> roleManager)
        {
            if(!roleManager.Roles.Any())
            {
                await roleManager.CreateAsync(new IdentityRole("Admin"));
