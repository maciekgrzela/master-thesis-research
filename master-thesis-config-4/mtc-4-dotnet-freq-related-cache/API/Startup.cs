    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IConnectionMultiplexer>(p =>
                ConnectionMultiplexer.Connect(Configuration.GetSection("RedisCacheSettings:ConnectionString").Value));
            ...
            if (redisCacheSettings.Enabled)
            {
                ...
                var executionFrequencyFile = File.ReadAllText(@"./Cache/execution-and-invalidation.frequency.json");
                var executionFrequency =
                    JsonConvert.DeserializeObject<List<ExecutionAndInvalidationFrequency>>(executionFrequencyFile);

                services.AddSingleton<List<ExecutionAndInvalidationFrequency>>(executionFrequency);
