...
namespace API.Controllers
{
    ...
    public class BillsController : BaseController
    {
        ...
        private readonly List<ExecutionAndInvalidationFrequency> executionAndInvalidationFrequencies;

        public BillsController(IMapper mapper, IBillService billService, List<ExecutionAndInvalidationFrequency> executionAndInvalidationFrequencies) : base(mapper)
        {
            this.billService = billService;
            this.executionAndInvalidationFrequencies = executionAndInvalidationFrequencies;
        }

        [HttpGet]
        [AllowAnonymous]
        [FrequencyRelatedCached]
        public async Task<IActionResult> ListAsync([FromQuery] PagingParams queryParams)
        {
            ...
            Console.WriteLine(executionAndInvalidationFrequencies[0].EndpointName);
